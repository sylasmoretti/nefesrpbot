...
exports.run = async(client, message, args) => {
  ...
  .setTitle(`${client.user.username} | Guard Bot sıfırlama komutu.`)
  .setColor(0x36393F)
  .setDescription(`Sunucu için ayarladığınız Guard Bot log başarıyla sıfırlandı!`)
 ...
 if(args[0] === "ayarla") {
    ...
    .setAuthor(client.user.username, client.user.avatarURL())  
    .setTitle(`${client.user.username} | Guard Botayarlama komutu.`)
    .setColor(0x36393F)
